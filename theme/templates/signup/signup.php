...
$IC = new Items();
$page_item = $IC->getItem(array("tags" => "page:signup", "status" => 1, "status" => 1, "extend" => array("user" => true, "tags" => true, "mediae" => true)));
if($page_item) {
...
<?	endif; ?>
		...
		<?= $model->input("maillist_name", array("type" => "hidden", "value" => "updates")); ?>
		...
		<ul class="actions">
			<?= $model->submit("Signup now", array("class" => "primary", "wrapper" => "li.signup")) ?>
		</ul>
	<?= $model->formEnd() ?>
